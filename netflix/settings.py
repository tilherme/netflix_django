...
if TOKEN_CSRF:
    ...
    CSRF_TRUSTED_ORIGINS =['https://netflixdjango-production-d61d.up.railway.app']
else:
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'filme.context.list_trending_movie',
                'filme.context.list_recent_movie'
...
LOGIN_REDIRECT_URL = 'filme:home_film'
